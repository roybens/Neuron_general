...
root_path_out = '/global/homes/t/tfenton/Neuron_general-2/Plots/12HMM16HMM/3-Debug_hetKO_061024'
...
vals =[10, 15, 20]#[-80,-70-60,-50,-40,-30]
...
for i12 in vals:
        for i16 in vals2:
                ...
                # simwt = tf.Na12Model_TF(ais_nav12_fac=7,ais_nav16_fac=7,nav12=2,nav16=2, somaK=1, KP=50, KT=1, #ais_nav12_fac=7,ais_nav16_fac=7,nav12=2.5,nav16=2.5, somaK=1, KP=50, KT=1
                ...
                sim = tf.Na12Model_TF(ais_nav12_fac=i12,ais_nav16_fac=i12,nav12=2,nav16=2, somaK=1, KP=50, KT=1, #ais_nav12_fac=7,ais_nav16_fac=7,nav12=2.5,nav16=2.5, somaK=1, KP=50, KT=1
                                ais_ca = 1,ais_Kca = 1, soma_na12=1, soma_na16=1, dend_nav12=1, node_na = 1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                                na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                                na16name = 'na16mut44_092623',na16mut_name = 'na16mut44_092623',na16mechs=['na16','na16mut'],params_folder = './params/',
                                plots_folder = f'{root_path_out}/2_ais1216-{i12}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                fig_volts.savefig(f'{sim.plot_folder}/2_ais1216-{i12}.pdf')
