...
for i12 in vals:
        for i16 in vals2:
                ...
                simwt = tf.Na12Model_TF(ais_nav12_fac=24,ais_nav16_fac=3,nav12=i12,nav16=i16, somaK=1, KP=100, KT=1, ##070324 nav12=6, nav16=4 ##062424 ais_nav12_fac=10,ais_nav16_fac=10,nav12=4,nav16=2.5 #ais_nav12_fac=7,ais_nav16_fac=7,nav12=2.5,nav16=2.5, somaK=1, KP=50, KT=1
                ...
                for mutname,dict in changesna16b.items():
                        ...
                        i12a=i12/2
                        sim = tf.Na12Model_TF(ais_nav12_fac=12,ais_nav16_fac=3,nav12=i12a,nav16=i16, somaK=1, KP=100, KT=1, #ais_nav12_fac=7,ais_nav16_fac=7,nav12=2.5,nav16=2.5, somaK=1, KP=50, KT=1
                                        ais_ca = 10,ais_Kca = 10, soma_na12=1, soma_na16=1, dend_nav12=1, node_na = 1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
