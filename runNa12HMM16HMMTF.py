...
root_path_out = './Plots/12HMM16HMM/23-scanVShiftManually_080524'
...
nf.modify_dict_file(filename12, changesna12_071824best)
nf.modify_dict_file(filename16, changesna16_071624best)


##TF080524 best HMM model params with n12=3.15 and n16=86.82
...
############temp params for changing AIS chan densities
# simwt = tf.Na12Model_TF(ais_nav12_fac=40,ais_nav16_fac=40,nav12=3*3,nav16=9, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
#         ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
#         na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
#         na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
#         plots_folder = f'{root_path_out}/', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
...
##Channel Densities
# NeuronModel.chandensities(name='AIS_chandensities_40_40')
...
# fig_volts.savefig(f'{simwt.plot_folder}/3-newAIS_1216-9.pdf')
...
## Best 12 and 16 params as of 072224
# shifts=[5,10,15,17,20]
shifts=[3,3.25,3.5]

for TFshift in shifts:
        n12hmmVshiftMan ={"a1_0": 3.1547345527269233, "a1_1": 0.05510300665105835, "b1_0": 4.791955661615136, "b1_1": 0.09014477225513692, "a2_0": 3015.155056494468, "a2_1": 0.30987923885393026, "b2_0": 919.3139955076967, "b2_1": 0.41962767235919507, "a3_0": 109.85728965102251, "a3_1": 0.24852254942384186, "b3_0": 1712.2193773613558, "b3_1": 0.01912898529951851, 
                                "bh_0": 8.027353908819931, "bh_1": 8.174548719738821, "bh_2": 0.11446203713204262, "ah_0": 0.06601487564289754, "ah_1": 405124.7535686269, "ah_2": 0.08651802346109899, "vShift": -23.438854488000004+TFshift, "vShift_inact": 15.461948540212093+TFshift, "maxrate": 11.685304243202804}
        # n16hmmVshiftFit={"a1_0": 97.88230506791679, "a1_1": 0.03698389529158251, "b1_0": 15.065966409542465, "b1_1": 0.001848765560648457, "a2_0": 10038.23302997219, "a2_1": 0.3332555725975974, "b2_0": 252.62301318638904, "b2_1": 0.5683687355416978, "a3_0": 646.5629543462013, "a3_1": 0.028154348637492, "b3_0": 500.0, "b3_1": 0.12340400027441137, 
        #                 "bh_0": 13.444953200356668, "bh_1": 10.37679821664995, "bh_2": 0.09872020889556168, "ah_0": 5.07743253875092, "ah_1": 568031.0445938959, "ah_2": 0.08553350693816006, "vShift": -6.287916488775884+TFshift, "vShift_inact": 6.927918529770826+TFshift, "maxrate": 27.668039090956086}
        n16hmmVshiftMan={"a1_0": 86.82768844997113, "a1_1": 0.12481160483736764, "b1_0": 0.03636308557245105, "b1_1": 0.07299197117480938, "a2_0": 5870.594264277059, "a2_1": 0.20381201621527256, "b2_0": 445.51379959201944, "b2_1": 0.014057437484476853, "a3_0": 1549.7689816436775, "a3_1": 0.08223497094200147, "b3_0": 460.3178077224841, "b3_1": 0.010814365773659428, 
                                "bh_0": 13.70152920233826, "bh_1": 9.233117481911744, "bh_2": 0.05775463093748526, "ah_0": 0.7125397402558968, "ah_1": 52695.59895637044, "ah_2": 0.07354314395481377, "vShift": -9.512610605026387+TFshift, "vShift_inact": 17.512316086445306+TFshift, "maxrate": 13.917366173297317}

        nf.modify_dict_file(filename12, n12hmmVshiftMan)
        nf.modify_dict_file(filename16, n16hmmVshiftMan)
...
# #         nf.modify_dict_file(filename16,dict)
                ...
                sim_ais12 = tf.Na12Model_TF(ais_nav12_fac=2*100*fac,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                sim_ais16 = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4*fac,nav12=3*3,nav16=7.5, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                sim_12 = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3*fac,nav16=7.5, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                sim_12.wtvsmut_stim_dvdt(wt_Vm=wt_Vm1,wt_t=wt_t1,sim_config=sim_config_soma,vs_amp=[0.5], fnpre=f'12-{fac}')
                

                sim_16 = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5*fac, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                sim_16.wtvsmut_stim_dvdt(wt_Vm=wt_Vm1,wt_t=wt_t1,sim_config=sim_config_soma,vs_amp=[0.5], fnpre=f'16-{fac}')
                
                
                sim_somaK = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5, somaK=50*0.25*fac, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                sim_KP = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5, somaK=50*0.25, KP=1000*3.56*fac, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                sim_aisKca = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                        ais_ca = 100,ais_Kca = 5*0.01*fac, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                        na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                        na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                        plots_folder = f'{root_path_out}/shift-{TFshift}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                sim_aisKca.wtvsmut_stim_dvdt(wt_Vm=wt_Vm1,wt_t=wt_t1,sim_config=sim_config_soma,vs_amp=[0.5], fnpre=f'aisKca-{fac}')
...
##TF061324 decent 1216HMM WT best so far
                ...
                ##TF071124 - 071524 best 12HMM with 62.7747
...
#                 changesna16_071524 = {"mut2345_6_TTP10":{"a1_0": 7.584729215687606, "a1_1": 0.002754486805072065, "b1_0": 0.5474360989773346, "b1_1": 0.038408753800255796, "a2_0": 11668.002263480768, "a2_1": 0.03996750786115068, "b2_0": 40.38544891976708, "b2_1": 4.819983913751836, "a3_0": 8.55438771908248, "a3_1": 0.038980403467684985, "b3_0": 46.30038375974366, "b3_1": 0.0008717364744730994, "bh_0": 30.16200692539098, "bh_1": 11.472703722221745, "bh_2": 0.12250216122128414, "ah_0": 1.5838021063970873, "ah_1": 124256.16280445634, "ah_2": 0.021468800099814493, "vShift": -8.6897581139405, "vShift_inact": -5.408201188962865, "maxrate": 212.02283088841887},
#                         # "mut2345_6_TTP11":{"a1_0": NaN, "a1_1": 0.0357181586690107, "b1_0": 2.0065106681659675, "b1_1": 0.021119702733462448, "a2_0": 5057.472274539977, "a2_1": 0.0007437864965493708, "b2_0": 44.499800422380595, "b2_1": 13.831497522808313, "a3_0": 264.30668241152534, "a3_1": 0.05397808399185741, "b3_0": 49.965989931691766, "b3_1": 0.012100202497052978, "bh_0": 19.737271949990117, "bh_1": 2.6043116390071983, "bh_2": 0.04606954880985667, "ah_0": 0.3543173786336622, "ah_1": 695551.7552761966, "ah_2": 0.15045686824866517, "vShift": NaN, "vShift_inact": 1.5237031227503512, "maxrate": 43.484355279595384},
