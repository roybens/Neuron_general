...
root_path_out = './Plots/12HMM16HMM/24-VshiftFits_080624'
...
n16hmmVshift080524={"mut24_n6_shift17":{"a1_0": 99.58955496652767, "a1_1": 0.17538979581093064, "b1_0": 4.052573344270064, "b1_1": 0.08548343579529136, "a2_0": 10159.50054530512, "a2_1": 0.2030090592848483, "b2_0": 489.50734807805185, "b2_1": 0.007215780833932373, "a3_0": 2106.8029775721784, "a3_1": 0.05464685279261905, "b3_0": 499.9763706257777, "b3_1": 0.07533646438290406, "bh_0": 7.674993639901338, "bh_1": 16.582250112234306, "bh_2": 0.11146725763507004, "ah_0": 8.842002875559979, "ah_1": 36427.48965151424, "ah_2": 0.022347384948566536, "vShift": -7.430772915964855, "vShift_inact": -4.580476335777777, "maxrate": 86.1240944849788}}

for mutname,dict in n12hmmVshift080524.items():
        ...
        sim_mut = tf.Na12Model_TF(ais_nav12_fac=2*100,ais_nav16_fac=10*4,nav12=3*3,nav16=7.5, somaK=50*0.25, KP=1000*3.56, KT=10, #nav12=3*2*1.5
                ais_ca = 100,ais_Kca = 5*0.01, soma_na12=2.5, soma_na16=1, dend_nav12=1, node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40, ##This row all 1 default
                na12name = 'na12_HMM_TEMP_PARAMS',mut_name = 'na12_HMM_TEMP_PARAMS',na12mechs = ['na12','na12mut'],
                na16name = 'na16_HMM_TEMP_PARAMS',na16mut_name = 'na16_HMM_TEMP_PARAMS',na16mechs=['na16','na16mut'],params_folder = './params/',
                plots_folder = f'{root_path_out}/{mutname}', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
        ...
        sim_mut.wtvsmut_stim_dvdt(wt_Vm=wt_Vm1,wt_t=wt_t1,sim_config=sim_config_soma,vs_amp=[0.5], fnpre=f'{mutname}')
