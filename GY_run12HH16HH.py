...
"""  # ##het model
  sim_het = tf.Na12Model_TF(ais_nav12_fac=12,ais_nav16_fac=12,nav12=1,nav16=1.3, somaK=1*2.2, KP=25*0.15, KT=5,
                              ...
                              na16name = 'na16HH_TF2',na16mut_name = 'na16HH_TF2',na16mechs=['na16','na16mut'],params_folder = './params/',
                              plots_folder = f'{root_path_out}/{path}/', update=True, fac=None)
  het_Vm1,_,het_t1,_ = sim_het.get_stim_raw_data(stim_amp = 1.5,dt=0.005,rec_extra=False,stim_dur=500, sim_config = sim_config_soma) #sim_config for changing regions
  ...
  sim_het.make_currentscape_plot(amp=1.5, time1=50,time2=100,stim_start=30, sweep_len=200,pfx='HET')
