...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK_E2 /global/u2/r/roybens/Neuron_general/Neuron_Model_HMM/mechanisms/SK_E2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/u2/r/roybens/Neuron_general/Neuron_Model_HMM/mechanisms/SK_E2.mod";
static const char* nmodl_file_text = 
