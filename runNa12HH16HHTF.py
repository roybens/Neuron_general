...
root_path_out = '/global/homes/t/tfenton/Neuron_general-2/Plots/12HMM16HH_TF/ManuscriptFigs/Restart030824/11-Debug_to_confirm_HHwt'
...
for i12 in vals:
        for i16 in vals2:
                ...
                ##TF052424 No change to mod params but still having update_mech_from_dict on works the best for HH
                ##No change to mod file params 12HH
                changesna12 = {
                        "sh": 8,#-3#i12,#8,
                        # "gbar": 0.01,#0.06,#0.1,#0.01,
                        "tha": -38,#i12,#-38,
                ...
                # No change to mod file params 16HH
                changesna16 = {
                        "sh": 8,
                        # "gbar": 0.01,
                        "tha": -47, #noshift=-40,
                ...
                fig_volts.savefig(f'{sim.plot_folder}/1-WT_updateon.pdf')
