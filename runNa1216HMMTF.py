...
vals =[2,3]#[-80,-70-60,-50,-40,-30]
vals2 = [2,3,4,5]#[-30,-40,-50,-60,-70,-80]#[1]
...
for i12 in vals:
        for i16 in vals2:
                ...
                sim = tf.Na12Model_TF(ais_nav12_fac=1,ais_nav16_fac=1,nav12=i12,nav16=i16, somaK=1, KP=100, KT=1, #somaK=10  KP=14,100 KT=40, ais_nav12_fac=1.5,ais_nav16_fac=1.5,nav12=1,nav16=8, nav1216=2;5-10=1,7, 12=2 16=0.5
                                ...
                                plots_folder = f'{root_path_out}/2-mut109tt8-1216HMM_1216_{i12}-{i16}TEST2', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                fig_volts.savefig(f'{sim.plot_folder}/2-mut109tt8-1216HMM_1216_{i12}-{i16}TEST2.pdf')
