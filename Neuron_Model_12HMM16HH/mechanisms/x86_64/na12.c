...
#define temp temp_na12
 ...
 "ah_2_na12", "/mV",
 "vShift_na12", "mV",
 "vShift_inact_na12", "mV",
 "vShift_inact_local_na12", "mV",
 "maxrate_na12", "/ms",
 "gna_na12", "millimho/cm2",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na12 /NG/Neuron_Model_12HMM16HH/mechanisms/na12.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/NG/Neuron_Model_12HMM16HH/mechanisms/na12.mod";
static const char* nmodl_file_text = 
