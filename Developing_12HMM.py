...
class Na1612Model:
    def __init__(self,na12name = 'na12_orig1',mut_name= 'na12_orig1',  na12mechs = ['na12','na12mut'],na16name = 'na12_orig1', mut16_name = 'na12_orig1' ,na16mechs = ['na16','na16mut'], params_folder = './params/' ,nav12=1,nav16=1,K=1,KT=1,KP=1,somaK=1,ais_ca = 1,ais_Kca = 1,soma_na16=1,soma_na12 = 1,node_na = 1,plots_folder = f'./Plots/Dev_12HMM/'):
     ...
     #na12 name and mut_name then you will have homozygus
        ...
        p_fn_na16 = f'{params_folder}{na16name}.txt'                              #newly added for developing na12 HMM  
        p_fn_na16_mech = f'{params_folder}{mut16_name}.txt'                       #newly added for developing na12 HMM
        ...
        print(f'using wt16_file {na16name}')                                       #newly added for developing na12 HMM 
        self.na16_p = update_mech_from_dict(self.l5mdl, p_fn_na16, self.wt16_mech) 
        print(f'using mut16_file {mut16_name}')
        self.na16_pmech = update_mech_from_dict(self.l5mdl, p_fn_na16_mech, self.mut16_mech)
