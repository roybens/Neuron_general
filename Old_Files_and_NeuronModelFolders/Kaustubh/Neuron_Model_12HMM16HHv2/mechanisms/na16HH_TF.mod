...
PARAMETER {
	sh   = 8	(mV)
	gbar = 0.06 :0.1   	(mho/cm2)	
								
	tha  =  -40(mV)		: v 1/2 for act ##TF021424 right shifting #-35 to-25 #left shift -45
	qa   = 7.2	(mV)		: act slope (4.5)		
	Ra   = 0.4	(/ms)		: open (v)		
	Rb   = 0.124 	(/ms)		: close (v)		

	thi1  = -30	(mV)		: v 1/2 for inact ##TF021424 right shift #-45	
	thi2  = -30 	(mV)		: v 1/2 for inact ##TF021424 right shift #-45	
