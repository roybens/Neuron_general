...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na16 /NG_Giselle/Neuron_Model_12HMM16HH/mechanisms/na16HH_TF.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/NG_Giselle/Neuron_Model_12HMM16HH/mechanisms/na16HH_TF.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
