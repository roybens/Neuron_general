...
for mutname,dict in n2_110824.items():
  ...
  root_path_out = f'./Plots/12HMM16HMM/32_newFits_110824/{mutname}'
  if not os.path.exists(root_path_out):
    os.makedirs(root_path_out)
...
# modify_dict_file(filename16,n6_102524)
  ...
  fig_volts,axs = plt.subplots(2,figsize=(cm_to_in(8),cm_to_in(15)))
  simtim.plot_stim(axs = axs[0],stim_amp = 0.5,dt=0.005, clr='cadetblue') #dt=0.005
  plot_dvdt_from_volts(simtim.volt_soma, simtim.dt, axs[1],clr='cadetblue')
  fig_volts.savefig(f'{root_path_out}/{mutname}_WT.pdf')
...
# fac=1
  for fac in (0.000001,0.00001,0.0001,1000,10000):
