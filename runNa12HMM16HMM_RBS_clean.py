...
root_path_out = './Plots/12HMM16HMM/18-RBS_clean_mut10_10_from071824'
...
fac=1
# for fac in (0.01,0.1,0.25,0.5,1,2,4,10,100,5,50):
# for fac in (3.565, 3.57, 3.58, 3.59):
# for fac in (0.0001,0.001,0.01):
# for fac in (1.5,1.75,2.25,2.5,2.75,3,3.25,3.5,3.75):
# for fac in (2.5,3):
# for fac in (5,10,15):
