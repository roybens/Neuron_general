...
root_path_out = '/global/homes/t/tfenton/Neuron_general-2/Plots/12HMM16HH_TF/ManuscriptFigs/Restart030824/6-HMM_focusonTTP_042624/5-mut10_4_TTP8'
...
for i12 in vals:
        for i16 in vals2:
                ...
                sim = tf.Na12Model_TF(ais_nav12_fac=1,ais_nav16_fac=1,nav12=2,nav16=7, somaK=1, KP=100, KT=1, #somaK=10  KP=14,100 KT=40, ais_nav12_fac=1.5,ais_nav16_fac=1.5,nav12=1,nav16=8, nav1216=2;5-10=1,7, 12=2 16=0.5
                                ...
                                na16name = 'na16HH_TF2',na16mut_name = 'na16HH_TF2',na16mechs=['na16','na16mut'],params_folder = './params/',
                                plots_folder = f'{root_path_out}/3-10_4-stim300ms', pfx=f'WT_', update=True) #2-12-{i12}_16-{i16}
                ...
                fig_volts.savefig(f'{sim.plot_folder}/3-10_4-stim300ms.pdf')
                # plt.clf()
                ...
                sim.make_currentscape_plot(amp=0.5, time1=250,time2=500,stim_start=300, sweep_len=500)
