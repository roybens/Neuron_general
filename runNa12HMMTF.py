...
root_path_out = '/global/homes/t/tfenton/Neuron_general-2/Plots/12HMM16HH_TF/ManuscriptFigs/Restart030824/4-FixModMistake_HH/23-fixUpdateAIS/5-TestAISFix'
...
# for i12 in vals:
        for i16 in vals2:
                ...
                ##TF040324 Testing HH model and beginning HMM model.
                sim = tf.Na12Model_TF(ais_nav12_fac=2,ais_nav16_fac=2,nav12=3,nav16=1, somaK=1, KP=100, KT=10, #somaK=10 KP=20, KP=90_KT=40
                                        ais_ca = 1,ais_Kca=1,soma_na16=1,soma_na12=1,node_na=1,#somaK=90, KP=20, KT=6,#somaK=30,  KP=40,
                                        na12name = 'na12annaTFHH2',mut_name = 'na12annaTFHH2',na12mechs = ['na12','na12mut'],
                                        na16name = 'na16HH_TF2',na16mut_name = 'na16HH_TF2',na16mechs=['na16','na16mut'],params_folder = './params/',
                                        plots_folder = f'{root_path_out}/9_somana12-{i12}', pfx=f'WT_', update=True)
                ...
                fig_volts.savefig(f'{sim.plot_folder}/9_somana12-{i12}.pdf')
