...
root_path_out = '/global/homes/t/tfenton/Neuron_general-2/Plots/12HMM16HH_TF/ManuscriptFigs/Fix1216distribution/Scans_newAIS_020724/na43_77AIS_muts'
...
# for i12 in np.arange(5,8,1):
        # for i16 in np.arange(5,8,1):
        

        #Make WT and save data for comparison later
        sim = tf.Na12Model_TF(ais_nav12_fac=7,ais_nav16_fac = 7,nav12=4,nav16=3,na12name = 'na12_HMM_TF100923',mut_name = 'na12_HMM_TF100923',
                        params_folder = './params/na12HMM_allsynthmuts_HOFs/',
                        plots_folder = f'{root_path_out}/4377', pfx=f'WT_')

        #soma
        wt_Vm1,wt_I1,wt_t1,wt_stim1 = sim.get_stim_raw_data(stim_amp = 0.5,dt=0.005,rec_extra=False,stim_dur=500, sim_config = sim_config_soma)
        #features_df = ef.get_features(sim=sim,mutTXT='WT_soma', mut_name = 'na12_HMM_TF100923')
        # sim.plot_model_FI_Vs_dvdt(wt_Vm=wt_Vm1,wt_t=wt_t1,sim_config=sim_config_soma,vs_amp=[0.5], fnpre=f'_{i12}_{i16}_')#fnpre=f'{mutTXT}')
